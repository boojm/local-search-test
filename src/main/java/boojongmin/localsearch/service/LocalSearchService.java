...
public class LocalSearchService {
    ...
    public LocationSearchModel locationSearch(String keyword, Optional<Integer> pageOpt) {
        int page = pageOpt.orElseGet(() -> {
            increaseScoreToSearchedKeyword(keyword);
            return 1;
        });
    ...
    public LocationSearchModel search(String keywoard, final int page) {
        var url = URL_PREFIX + "/v2/local/search/keyword.json";
        url += "?query=" + keywoard;
        url += "&page=" + page;
